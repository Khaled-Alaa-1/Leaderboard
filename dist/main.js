...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_sendAndRceive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sendAndRceive */ \"./src/modules/sendAndRceive.js\");\n\n\n\nconst refreshBtn = document.querySelector('.refreshBtn');\nrefreshBtn.addEventListener('click', () => {\n  (0,_modules_sendAndRceive__WEBPACK_IMPORTED_MODULE_1__.refresh)();\n});\n\nconst submitBtn = document.querySelector('.submitBtn');\nsubmitBtn.addEventListener('click', () => {\n  (0,_modules_sendAndRceive__WEBPACK_IMPORTED_MODULE_1__.addYourData)();\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");

/***/ }),

/***/ "./src/modules/sendAndRceive.js":
/*!**************************************!*\
  !*** ./src/modules/sendAndRceive.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addYourData\": () => (/* binding */ addYourData),\n/* harmony export */   \"refresh\": () => (/* binding */ refresh)\n/* harmony export */ });\nconst getData = async () => {\n  try {\n    const response = await fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/fLoGKSnzO7NKnfAIea7H/scores/', {\n      method: 'GET',\n    });\n    const data = await response.json();\n    return data;\n  } catch (error) {\n    return error;\n  }\n};\n\ngetData();\n// RENDER THE ARRAY OF SCORES IN THE HTML\n\nconst refresh = async () => {\n  const data = await getData();\n\n  data.result.sort((a, b) => b.score - a.score);\n\n  const scoreContainer = document.querySelector('.score-container');\n\n  scoreContainer.innerHTML = '';\n\n  for (let i = 0; i < data.result.length; i += 1) {\n    const html = `<li>${data.result[i].user}: ${data.result[i].score}</li>`;\n\n    scoreContainer.innerHTML += html;\n  }\n};\n\n// ADD A NEW SCORE TO THE API\n\nconst addYourData = () => {\n  try {\n    const inputName = document.querySelector('.inputName');\n\n    const inputScore = document.querySelector('.inputScore');\n\n    if (inputName !== '' && inputScore !== '') {\n      const dataToSend = {\n\n        user: inputName.value,\n\n        score: parseInt(inputScore.value, 10),\n\n      };\n\n      fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/SNypXgDAYR2s53JoVMhD/scores', {\n\n        method: 'POST',\n\n        headers: {\n\n          'Content-Type': 'application/json',\n\n        },\n\n        body: JSON.stringify(dataToSend),\n\n      });\n    }\n\n    inputName.value = '';\n\n    inputScore.value = '';\n  } catch (error) {\n    return error;\n  }\n\n  return null;\n};\n\n//# sourceURL=webpack://leaderboard/./src/modules/sendAndRceive.js?");
